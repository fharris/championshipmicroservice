...
echo "############################"
echo "############################"
kubectl apply -f appconfig/championshipms-namespace.yaml;
...
kubectl -n curiosityevents set image deployment/championshipms-deployment consumerms=fra.ocir.io/frsxwtjslf35/wikipedia/demo/consumerms:latest
